module ProyectosHelper
    def enlaceMenuItem
        "<button id='dropdownSmallButton' data-dropdown-toggle='dropdownSmall' class='inline-flex items-center px-3 py-2 mb-3 me-3 text-sm font-medium text-center text-white bg-blue-700 rounded-lg md:mb-0 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800' type='button'>
            Archivar 
